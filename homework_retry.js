...
//改变轮播图
    ...
    var tabs = document.getElementsByClassName('belly2-pages')[0].getElementsByTagName('h2'),
        contents = document.getElementsByClassName('belly3-content')[0].getElementsByTagName('section');
